...
`jaeger` | Jaeger API tracing environment variables such as JAEGER_SERVICE_NAME, JAEGER_AGENT_HOST, JAEGER_AGENT_PORT to send traces to Jaeger Agent | `- name: JAEGER_AGENT_PORT` <br/> &nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  `port: 6831` <br/> see [values.yaml](https://github.com/egovernments/eGov-infraOps/blob/helm/helm/charts/common/values.yaml)
